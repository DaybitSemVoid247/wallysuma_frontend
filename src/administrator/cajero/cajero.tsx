      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 border-l-4 border-cyan-600">
          <h1 className="text-3xl font-bold text-gray-800 flex items-center gap-3">
            <HiOutlineShoppingCart className="text-cyan-600" size={36} />
            Sistema de Caja - Nuevo Pedido
          </h1>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-cyan-600">
              ...
              {!usuarioSeleccionado ? (
                <>
                  <div className="relative mb-4">
                    ...
                    <input
                      ...
                      className="w-full pl-10 p-3 border-2 border-gray-300 rounded-lg focus:border-cyan-600 outline-none"
                    />
                  </div>
                  <div className="max-h-48 overflow-y-auto space-y-2">
                    {usuariosFiltrados.map((usuario) => (
                      <div
                        ...
                        className="p-3 border-2 border-gray-200 rounded-lg hover:bg-cyan-50 hover:border-cyan-600 cursor-pointer transition"
                      >
                ...
                <div className="flex items-center justify-between p-4 bg-cyan-50 rounded-lg border-2 border-cyan-600">
                  <div>
              ...
              {carrito.length === 0 ? (
                ...
                <div className="space-y-3 mb-4 max-h-64 overflow-y-auto">
                  {carrito.map((item) => (
                    <div
                      key={item.productoId}
                      className="flex items-center justify-between border-b-2 border-gray-200 pb-3"
                    >
            ...
            <div className="bg-white rounded-lg shadow-md p-6 space-y-4">
              ...
              <div className="space-y-2 pt-4">
                <button
                  ...
                  className="w-full bg-cyan-600 text-white py-4 rounded-lg font-bold hover:bg-cyan-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition text-lg border-2 border-cyan-700"
                >
                  {procesando ? "Procesando..." : "Crear Pedido"}
                </button>
                <button
                  onClick={limpiarFormulario}
                  className="w-full bg-gray-200 text-gray-800 py-3 rounded-lg font-bold hover:bg-gray-300 transition border-2 border-gray-300"
                >
                  Limpiar Todo
                </button>
              </div>
            ...
            >
              ...
              <div className="p-8 text-center">
                ...
                <button
                  ...
                  disabled={procesando}
                  className="w-full bg-cyan-600 text-white py-3 rounded-lg font-bold hover:bg-cyan-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition"
                >
