        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 border-l-4 border-cyan-600">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl font-bold text-gray-800 flex items-center gap-3">
              <HiOutlineChartBar className="text-cyan-600" size={36} />
              Dashboard de Estadísticas
            </h1>
            <button
              onClick={cargarDatos}
              disabled={loading}
              className="flex items-center gap-2 px-4 py-2 bg-cyan-600 text-white rounded-lg hover:bg-cyan-700 font-semibold disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              <HiOutlineRefresh
                size={20}
